(defprod element (button ((id string) (expr expression)
  ...
  (to-html (path) (div (list :class 'well) 
		       (div nil (text "Pulsante identificato come ~a e etichettato con la seguente espressione:" (lower id)) 
			    (synth to-html expr))
		       (if click (div nil (text "Sottoposto a click, effettua la seguente azione:") (synth to-html click)))
		       (if hover (div nil (text "Sottoposto a hover, effettua la seguente azione:") (synth to-html hover))))))
